...
The framework evaluates quantity function expressions with \code{blockName} and \code{perNMinutes}/\code{perNHours} fields by dividing the duration of the procedure block with the number of minutes / hours.
