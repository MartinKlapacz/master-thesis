...
The following rule matches if we have a \code{skinChangeExaminations} block with \code{skinChangePresent} set to \true,
...
This condition generates conflicts between the rule's conclusion and all special special GOÄ codes in the current result set.
