...
The previous usages of billings codes in the current treatment, visit, billing case can be relevant for further billing.
...
\code{maxAmountPerDay}, \code{maxAmountPerMonth} and \code{maxAmountPerYear} are condition fields that restrict the number of code usages for different time spans.
