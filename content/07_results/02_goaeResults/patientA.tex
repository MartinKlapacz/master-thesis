...
The rule engine also computed the quantity by evaluating each child function for the corresponding localization field in the \code{spineInfiltration} object and returned the correct amount of four.
