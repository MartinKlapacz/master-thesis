\section{Rule Core}\label{sec:rule-core}
...
For example, the most important enum type that is used in a large amount of physical examination block contents is \code{AbnormalitiesExaminationResult}.
