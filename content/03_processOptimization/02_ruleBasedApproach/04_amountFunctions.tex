...
The code snipped\ref{lst:spineInfiltration} displays a simplified version of the \code{SpineInfiltrationMsg}procedure block.
\lstinputlisting[label={lst:spineInfiltration}][
    language=protobuf3,
    style=protobuf,
